  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe, getSnapshot) {
        didWarnOld18Alpha || void 0 === React29.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React29 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState10 = React29.useState, useEffect9 = React29.useEffect, useLayoutEffect2 = React29.useLayoutEffect, useDebugValue2 = React29.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React29 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore4 = shim.useSyncExternalStore, useRef20 = React29.useRef, useEffect9 = React29.useEffect, useMemo15 = React29.useMemo, useDebugValue2 = React29.useDebugValue;
...
function useFloatingPortalNode(props = {}) {
  ...
  return {
    ...
    nodeId: React2.isValidElement(portalElement) ? portalElement.props.id : void 0,
...
function handleTabIndex(floatingFocusElement) {
  ...
  if (!((_a = floatingFocusElement.getAttribute("role")) == null ? void 0 : _a.includes("dialog"))) {
    return;
  }
...
var BasePopupHandle = class {
  ...
  constructor(fallbackStore, componentName, throwOnMissingTrigger = true) {
     ...
     */
    __publicField(this, "attachedStores", []);
    /**
  ...
  attachStore(newStore) {
    ...
    if (true) {
      if (this.attachedStores.length > 1) {
        const dev = this;
        (dev.overlapWarningFrame ?? (dev.overlapWarningFrame = AnimationFrame.create())).request(() => {
          if (this.attachedStores.length > 1) {
  ...
  openByTrigger(triggerId) {
    ...
    if (triggerId) {
      ...
      triggerElement ?? (triggerElement = this.fallbackStore.context.triggerElements.getById(triggerId));
    }
...
function useSyncedFloatingRootContext(options) {
  ...
  const internalStoreRef = React12.useRef(null);
...
function useTriggerDataForwarding(triggerId, triggerElementRef, store, stateUpdates) {
  ...
  const registerTrigger = React13.useCallback((element) => {
...
function useImplicitActiveTrigger(store, options = {}) {
  ...
  const resolvedActiveTriggerIdRef = React13.useRef(null);
  const open = store.useState("open");
...
function usePopupHandleStore(handle) {
  const subscribe = React14.useCallback((listener) => {
    if (handle === void 0) {
      return NOOP;
    }
    return handle.subscribeStore(listener);
  }, [handle]);
  const getSnapshot = React14.useCallback(() => {
    return handle === void 0 ? void 0 : handle.store;
  }, [handle]);
  return (0, import_shim3.useSyncExternalStore)(subscribe, getSnapshot, () => handle == null ? void 0 : handle.serverStore);
}

// node_modules/@base-ui/react/utils/popups/popupTriggerMap.mjs
var devElementIdsByMap;
function getDevElementIds(map) {
  devElementIdsByMap ?? (devElementIdsByMap = /* @__PURE__ */ new WeakMap());
...
var PopupTriggerMap = class {
  ...
  delete(id) {
    ...
    if (true) {
      ...
      if (element !== void 0) {
        (_a = devElementIdsByMap == null ? void 0 : devElementIdsByMap.get(this)) == null ? void 0 : _a.delete(element);
      }
    }
...
function useListNavigation(context, props) {
  ...
  const indexRef = React18.useRef(selectedIndex ?? -1);
  const keyRef = React18.useRef(null);
  const isPointerModalityRef = React18.useRef(true);
  const onNavigate = useStableCallback((event) => {
    onNavigateProp(indexRef.current === -1 ? null : indexRef.current, event);
  });
  const previousMountedRef = React18.useRef(!!floatingElement);
  ...
  const cancelQueuedFocusRef = React18.useRef(null);
...
function useTypeahead(context, props) {
  ...
  const onKeyDown = useStableCallback((event) => {
    function getElement(index3) {
      return elementsRef == null ? void 0 : elementsRef.current[index3];
    }
    function isItemAvailable(index3) {
      const element = getElement(index3);
      if (element && !isElementVisible(element) || (element == null ? void 0 : element.matches(":disabled"))) {
        return false;
      }
    ...
    const allowRapidSuccessionOfFirstLetter = listContent.every((text, index3) => {
      var _a, _b;
      return text && isItemAvailable(index3) ? ((_a = text[0]) == null ? void 0 : _a.toLowerCase()) !== ((_b = text[1]) == null ? void 0 : _b.toLowerCase()) : true;
    });
  ...
  const sharedProps = React19.useMemo(() => ({
    onKeyDown,
    onBlur
  }), [onKeyDown, onBlur]);
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3XO6LISU.js.map
